---
title: "Welcome to Fluera"
description: "The essential map. Where to start, what to skip on your first session, and the three things that will decide whether Fluera works for you."
...
Welcome. This is the user documentation — practical guidance for making Fluera work the way it was designed to. If you are looking for the *why* (the research, the cognitive science, the design philosophy), start at [the science page](/science) instead.
...
- [Your first canvas](/docs/first-canvas) — a walk-through of the basic flow
- [Brushes and gestures](/docs/brushes) — what each brush does, how to draw without pain
- [The 12-step cycle](/science#learning-cycle) — the pedagogy the product is built around
