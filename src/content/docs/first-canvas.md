...
description: "A ten-minute walk-through of the basic flow: create, capture, reconstruct, question, confront. All on one canvas."
...
- [Brushes](/docs/brushes) — when to use which one
- [Canvas gestures](/docs/gestures-zoom) — pan, zoom, rotate, select
- [Socratic mode in depth](/docs/features-overview)
