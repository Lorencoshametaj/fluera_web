...
Nå svarer du — for hånd, i et beskyttet kladdeområde på samme canvas, akkurat slik du ville skrevet det på den ekte eksamenen. Ingen autocomplete. Ingen kopier-lim. Ingen "regenerer". Bare du og siden.
...
- **Multi-fag Exam Sessions** — én økt som veksler mellom klynger fra ulike fag på samme canvas og trener overføring.
