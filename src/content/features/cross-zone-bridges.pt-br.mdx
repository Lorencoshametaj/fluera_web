...
shortDescription: "Pontes anotadas persistentes entre regiões distantes do mesmo canvas. Declarar um link de transfer é por si só uma jogada de codificação generativa — o Fluera mantém a ponte viva através de reflow, time travel e Atlas."
status: beta
stepInCycle: 9
relatedPrinciples:
  - concept-mapping
...
Afaste o zoom até a vista continente do [Atlas](/pt-br/features/atlas). Escolha duas zonas distantes do mesmo canvas — inclusive de matérias diferentes. Toque em **+ Bridge**, trace uma linha entre elas e escreva uma anotação de uma frase explicando *por que* elas pertencem juntas.
...
- **Escopo Exam de toda a graduação** — inclui todas as pontes em uma Exam Session e usa o interleaving entre regiões de matérias do mesmo canvas.
