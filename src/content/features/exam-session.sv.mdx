...
Svara nu — för hand, i en skyddad kladdyta på samma canvas, exakt som du skulle skriva på det riktiga provet. Ingen autocomplete. Ingen kopiering och inklistring. Inget "regenerera". Bara du och sidan.
...
- **Multidisciplin-Exam Sessions** — en session som växlar mellan kluster från olika ämnen på samma canvas och tränar transfer.
