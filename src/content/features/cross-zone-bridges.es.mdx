...
shortDescription: "Puentes anotados persistentes entre regiones distantes del mismo canvas. Declarar un enlace de transfer es de por sí una jugada de codificación generativa — Fluera mantiene el puente vivo a través de reflow, time travel y Atlas."
status: beta
stepInCycle: 9
relatedPrinciples:
  - concept-mapping
...
Aleja a la vista continente de [Atlas](/es/features/atlas). Elige dos zonas distantes del mismo canvas — incluso entre asignaturas distintas. Toca **+ Bridge**, traza una línea entre ellas y escribe una anotación de una frase explicando *por qué* van juntas.
...
- **Scope Exam de toda la carrera** — incluye todos los puentes en una Exam Session y aplica el interleaving entre regiones de distintas asignaturas del mismo canvas.
