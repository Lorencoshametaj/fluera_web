...
Flanigan y colegas (2024) añaden la tercera pata, honestos sobre su tamaño: a lo largo de 24 estudios, la mano supera al teclado en rendimiento por un margen pequeño pero fiable, un margen que *crece* en los estudiantes que repasan lo que escribieron. El EEG de alta densidad de van der Meer muestra que escribir a mano moviliza redes más amplias que teclear: es un correlato neural, no una medida de cuánto aprendes, y si es el movimiento en sí el que codifica algo sigue siendo una hipótesis. El canal espacial ese sí está asentado, y el repaso es el momento en que cobras los dos.
...
- **Teleport entre regiones** — marcadores en posiciones distantes del mismo canvas y salto mediante pistas espaciales.
- **Importar desde la imaginación** — lugares descritos por voz se convierten en regiones del canvas (experimental, R&D).

**Para profundizar:** [cómo memorizar anatomía más rápido](/es/blog/how-to-memorize-anatomy) y [las mejores apps para tomar apuntes en Medicina](/es/blog/best-note-taking-apps-medical-students).
