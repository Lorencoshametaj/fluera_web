...
Flanigan en collega's (2024) voegen het derde been toe, en zijn eerlijk over de omvang: over 24 studies heen verslaat handschrift typen op prestatie met een kleine maar betrouwbare marge — een marge die *groeit* bij studenten die teruglezen wat ze schreven. Van der Meers hoge-dichtheids-EEG laat zien dat handschrift bredere netwerken inschakelt dan typen: een neuraal correlaat, geen maat voor hoeveel je leert, en of de beweging zelf iets codeert blijft een hypothese. Het ruimtelijke kanaal is het kanaal dat wél vaststaat — en het terugkijken is het moment waarop je beide incasseert.
...
- **Teleport tussen regio's** — maak bookmarks van verre posities op hetzelfde canvas en spring ertussen via ruimtelijke cues.
