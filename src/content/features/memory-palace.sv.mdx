...
Flanigan och kolleger (2024) lägger till det tredje benet, och är ärliga om storleken: över 24 studier slår handskrift tangentbord på prestation med en liten men pålitlig marginal — en marginal som *växer* hos studenter som repeterar det de skrivit. Van der Meers högdensitets-EEG visar att handskrift engagerar bredare nätverk än tangentbord: ett neuralt korrelat, inte ett mått på hur mycket du lär dig, och om själva rörelsen kodar något är fortfarande en hypotes. Det rumsliga spåret är det som står fast — och repetitionen är stunden då du hämtar hem båda.
...
- **Teleport mellan regioner** — bokmärk avlägsna platser på samma canvas och hoppa mellan dem via rumsliga ledtrådar.
