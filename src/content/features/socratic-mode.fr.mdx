...
- **Socratic entre régions** — l'IA propose des questions qui relient ton sujet actuel à des régions antérieures ou éloignées du même canvas, en exploitant l'interleaving.
- **Packs Socratic** d'auteurs spécialistes pour des champs spécifiques (médecine, droit, ML).

**Pour aller plus loin :** [préparer l’USMLE Step 1 en 2026](/fr/blog/usmle-step-1-study-guide-2026) et [les alternatives à Anki pour la médecine](/fr/blog/anki-alternatives-medical-students).
