...
Agora responda — à mão, numa região de rascunho protegida do mesmo canvas, exatamente como escreveria na prova de verdade. Sem autocompletar. Sem copiar e colar. Sem "regerar". Só você e a página.
...
- **Exam Sessions multi-disciplina** — uma sessão que alterna clusters de matérias diferentes no mesmo canvas, treinando transfer.

**Para aprofundar:** [como estudar para o USMLE Step 1 em 2026](/pt-br/blog/usmle-step-1-study-guide-2026) e [a ciência da repetição espaçada ao longo do curso](/pt-br/blog/spaced-repetition-medical-school).
