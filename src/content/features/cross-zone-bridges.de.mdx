...
shortDescription: "Persistente, annotierte Brücken zwischen entfernten Regionen desselben Canvas. Einen Transfer-Link zu erklären, ist an sich eine generative Kodierungs-Bewegung — Fluera hält die Brücke über Reflow, Time Travel und Atlas hinweg lebendig."
status: beta
stepInCycle: 9
relatedPrinciples:
  - concept-mapping
...
Zoome bis zur Kontinent-Ansicht von [Atlas](/de/features/atlas) heraus. Wähle zwei entfernte Zonen desselben Canvas — auch aus verschiedenen Fächern. Tippe **+ Bridge**, ziehe eine Linie zwischen ihnen und schreibe eine Ein-Satz-Annotation, die erklärt, *warum* sie zusammengehören.
...
- **Studienweiter Exam-Scope** — bezieht alle Brücken in eine Exam Session ein und nutzt Interleaving zwischen Fachregionen desselben Canvas.
