...
shortDescription: "Atlas bringt konzeptuelle Brücken zwischen weit entfernten Regionen deines einzigen Canvas zum Vorschein — Chemie, die an Analysis zieht, Geschichte, die in Wirtschaft nachhallt. Transfer of Learning, visuell navigierbar."
status: beta
stepInCycle: 9
relatedPrinciples:
  - concept-mapping
...
Pinch out. Weiter pinchen. Die Fachregionen in deinem Canvas — Biologie, organische Chemie, Statistik, Philosophie — ziehen sich zu einer **Kontinent-Ansicht** zurück. Atlas läuft im Hintergrund, während du heraus zoomst: Er liest Cluster-Namen, Stroke-OCR und die von dir gezeichneten Beziehungen und projiziert eine Karte desselben zusammenhängenden Raums.
...
- **Fächerübergreifende Exam Sessions** — eine Session, die Cluster aus mehreren Fachregionen desselben Canvas interleavet und Transfer direkt trainiert.
- **Atlas-Tags** — automatisch erkannte thematische Stränge (z. B. „Gleichgewicht", „Feedback", „Komposition"), die in entfernten Regionen auftauchen.
- **Atlas-gesteuertes Socratic** — Fragen, die zwei Fächer überbrücken, die du noch nicht verbunden hast.

**Zum Weiterlesen:** [die besten Notiz-Apps für Medizinstudierende](/de/blog/best-note-taking-apps-medical-students) und [USMLE Step 1 im Jahr 2026 vorbereiten](/de/blog/usmle-step-1-study-guide-2026).
