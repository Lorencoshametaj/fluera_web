...
Jos haluat oppia paremmin, voit aloittaa tänään ilman Flueraa — sulje kirja, kirjoita mitä vielä muistat, palaa huomenna. Jos haluat työkalun, joka tekee näistä tavoista helpoimman tien, [tässä on beta](/fi/beta).
