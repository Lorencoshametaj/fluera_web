...
Se você quer o melhor app de anotações para estudantes de medicina sem ler duas mil palavras, é este — e a resposta honesta é que depende de uma coisa só, a tarefa:

- **Captar aulas num iPad** → **GoodNotes 6**. A melhor busca de manuscrito do grupo, US$ 29,99 uma vez só. Notability se você quiser o áudio sincronizado com o que estava escrevendo.
- **Um app de notas grátis que funcione em tudo** → **OneNote**. Escrita à mão mais fraca que nos apps de iPad, busca excelente, custo zero.
- **Uma base de referência construída ao longo do curso** → **Notion** ou **Obsidian**.
- **Cartões vivendo dentro das anotações** → **RemNote**.
- **O menor atrito possível em hardware Apple** → **Notas da Apple**.
- **Sintetizar entre sistemas, com as anotações guiando a revisão** → um canvas infinito. É a categoria em que construímos, e o resto do texto é o argumento de por que ela é uma *espécie* diferente de ferramenta, e não uma marca melhor da mesma.

Se captar aulas é todo o seu problema, pare de ler e compre o GoodNotes. O resto deste texto é para o caso em que não seja.
...
**Para continuar lendo:** [alternativas ao Anki para medicina](/pt-br/blog/anki-alternatives-medical-students), [a ciência da repetição espaçada ao longo do curso](/pt-br/blog/spaced-repetition-medical-school), [como memorizar anatomia mais rápido](/pt-br/blog/how-to-memorize-anatomy) e [como estudar para o USMLE Step 1 em 2026](/pt-br/blog/usmle-step-1-study-guide-2026).
