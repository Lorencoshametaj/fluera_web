...
If you want the best note-taking app for medical students without reading two thousand words, here it is — and the honest answer is that it depends on one thing, the task:

- **Capturing lectures on an iPad** → **GoodNotes 6**. Best handwriting search of the lot, $29.99 once. Notability instead if you want audio that syncs to what you were writing.
- **A free notes app that works on everything** → **OneNote**. Weaker handwriting than the iPad apps, excellent search, costs nothing.
- **A reference base you build across four years** → **Notion** or **Obsidian**.
- **Flashcards living inside the notes** → **RemNote**.
- **The least friction possible on Apple hardware** → **Apple Notes**.
- **Synthesising across organ systems, with your notes driving your revision** → an infinite canvas. That is the category we build in, and the rest of this post is the argument for why it is a different species of tool rather than a better brand of the same one.

If lecture capture is your whole problem, stop reading and buy GoodNotes. The rest of this article is for the case where it isn't.
...
**Handwriting edges out typing — by less than you have been told.** <Citation authors="Flanigan et al." year="2024" href="/research">A 2024 meta-analysis in Educational Psychology Review</Citation> pooled 24 studies covering roughly 3,000 college students. Typing wins decisively on one axis: typed notes hold far more words. Handwriting wins on the axis that matters, achievement, at Hedges' g = 0.248 — reliably measured, and small. In the paper's own binomial display that is about 9.5% of handwriters reaching an A against 6% of typists.

It is worth saying plainly that this replaced an older and much bolder claim, because you will still find the old one everywhere. For a decade the standard citation was Mueller and Oppenheimer's 2014 study, which reported a large conceptual-recall advantage for longhand. That study did not survive direct replication — Morehead, Dunlosky and Rawson in 2019, then Urry and colleagues in 2021, who added a mini meta-analysis across eight related studies and found essentially nothing. The finding outlived its source: an effect near g = 0.25 is simply too small for one study of 142 people to detect. Separately, high-density EEG work by <Citation authors="van der Meer et al." year="2020" href="/research">Audrey van der Meer and colleagues</Citation> shows broader activation during handwriting than during typing. That is a neural correlate, not a measure of learning, and it should not be read as one.

For medical school the practical implication is narrower than "don't type". The modality is worth a small edge. What you do with the notes afterwards is worth a great deal more — which is exactly what the next finding is about.

**Note-taking matters more for review than for capture.** A second strand of the literature shows that *reviewing your notes* produces more learning than the original act of taking them. The 2024 meta-analysis tested this directly as a moderator, and the result points the same way: the handwriting advantage got *larger* when students had the chance to review before assessment, not smaller. The value of writing by hand is not spent while you write it. It is collected later, when you come back. The implication: notes are worth taking primarily because they create something to retrieve from later, and the act of retrieval is what produces durable memory. Notes that look great but never get reviewed are mostly performative.
...
| **Fluera** | Infinite canvas | Excellent | Yes | Yes (sync, Pro) | Cross-platform | Free + €9.99/€19.99 |
...
**Related reading:** [alternatives to Anki for medical school](/blog/anki-alternatives-medical-students), [the science of spaced repetition across four years](/blog/spaced-repetition-medical-school), [how to memorize anatomy faster](/blog/how-to-memorize-anatomy) and [studying for USMLE Step 1 in 2026](/blog/usmle-step-1-study-guide-2026).
