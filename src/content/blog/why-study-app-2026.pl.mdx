...
Jeśli to ci rezonuje — [chodź budować z nami w becie](/pl/beta). Jeśli nie rezonuje, też dobrze. Nie każde narzędzie jest dla każdego uczącego się. To jest dla tych, którzy potrafią rozróżnić.
