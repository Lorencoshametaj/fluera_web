...
const data: PricingData = {
  ...
  faq: [
    ...
    },
    {
      ...
      a: "Coming in phase 2 (shared workspaces, admin dashboard, SSO). Interested? Email support@fluera.dev — we're building the roadmap with our first design partners.",
    },
  ],
};
