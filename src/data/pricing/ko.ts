...
const data: PricingData = {
  ...
  faq: [
    ...
    },
    {
      ...
      a: "모든 내용은 기기에 그대로 남고(local-first), 기본 브러시 3종과 PNG 내보내기는 Free에서도 계속 작동합니다. 유료 플랜 기능은 다시 활성화할 때까지 일시 중지됩니다. 명시적인 작업 없이 삭제되는 것은 없습니다.",
    },
    {
      q: "Pro 무료 체험은 왜 없나요?",
    ...
    {
      q: "환불 정책은?",
      a: "환불 및 철회 조건은 스토어와 구매 경로에 따라 다릅니다. 적용되는 정책은 확정 전에 표시되며, 도움이 필요하면 가입한 주소에서 support@fluera.dev로 문의해 주세요.",
    },
    {
      q: "학생 인증은 어떻게 작동하나요?",
