...
const data: PricingData = {
  ...
  faq: [
    ...
    },
    {
      ...
      a: "Kommen in Phase 2 (geteilte Workspaces, Admin-Dashboard, SSO). Interesse? E-Mail an support@fluera.dev — wir bauen die Roadmap mit unseren ersten Design-Partnern.",
    },
  ],
};
