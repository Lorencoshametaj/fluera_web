  ...
  tiers: [
    {
      ...
      features: [
        ...
        "PNG एक्सपोर्ट",
        "हर महीने 100 AI क्रेडिट — Atlas हमेशा मुफ़्त (0 क्रेडिट), Chat प्रति संदेश 1",
    ...
    },
    {
      name: "Plus",
      price: "€9.99",
      period: "प्रति माह · €99.99 / वर्ष (€19.89 बचाएँ — 2 महीने मुफ़्त)",
      tagline:
    ...
    },
    {
      name: "Pro",
      price: "€19.99",
      period: "प्रति माह · €199.99 / वर्ष (€39.89 बचाएँ — 2 महीने मुफ़्त)",
      tagline:
  ...
  faq: [
    {
      ...
      a: "हर AI ऑपरेशन की एक तय क्रेडिट लागत है: Ghost Map 8, Socratic प्रति stage 4, Exam प्रति प्रश्न 12, Chat प्रति संदेश 1। Atlas (canvas actions) मुफ़्त है। प्रोऐक्टिव Background OCR प्रति पृष्ठ 1 क्रेडिट लेता है और Pro प्लान में है। आप हमेशा canvas हेडर में बचे क्रेडिट देखते हैं — कोई छिपी हुई rate limits नहीं, कोई आश्चर्य नहीं। अप्रयुक्त क्रेडिट आगे नहीं बढ़ते: प्लान आपकी सब्सक्रिप्शन तारीख से हर 30 दिन में रीफिल होता है (महीने की 1 तारीख को नहीं — आप 30 दिन के लिए भुगतान करते हैं और 30 दिन पाते हैं)।",
    },
    {
    ...
    },
    {
      ...
      a: "Phase 2 में आ रहे हैं (shared workspaces, admin dashboard, SSO)। रुचि है? support@fluera.dev पर email करें — हम अपने पहले design partners के साथ roadmap बना रहे हैं।",
    },
  ],
};
