...
const data: HomeData = {
  ...
  authors: [
    ...
    { name: "Flanigan y colegas", contribution: "En 24 estudios, los apuntes a mano rinden algo más que los tecleados — una ventaja pequeña, que crece al repasarlos.", year: "2024" },
