...
const data: HomeData = {
  steps: [
    ...
    { n: 9,  title: "Cross-Zone Bridges", verb: "Weeks later",    description: "Zoom out to the Atlas. Draw Cross-Zone Bridges between chemistry and differential equations. Transfer is the real test of learning." },
